...
! function (t) {
    ...
    t.exports = {
        copy: function t(e) {
            ...
            if (e && "object" == typeof e) {
                for (a = {}, n = [Array, Number, String, Boolean], i = 0; i < n.length; i++) e instanceof n[i] && (a = i ? new n[i](e) : new n[i]);
                for (i in r.isDate(e) && (a = new Date(e)), e) Object.prototype.hasOwnProperty.apply(e, [i]) && (a[i] = t(e[i]))
            }
            return a || e
        },
        defined: function (t) {
    ...
    function o(t) {
        if (!t) return "";
        var e = t.className || "";
        return e.baseVal && (e = e.baseVal), e.indexOf || (e = ""), c(e)
    }
        ...
        locateClassName: function (t, e, i) {
            ...
            for (var n = d(t), r = ""; n;) {
                if (r = o(n)) {
                    ...
                    if (a >= 0) {
                        if (!i) return n;
                        var s = 0 === a || !c(r.charAt(a - 1)),
                            l = a + e.length >= r.length || !c(r.charAt(a + e.length));
                        if (s && l) return n
                    }
                }
                n = n.parentNode
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (t) {
            var e, i = "<div class='gantt_cal_ltext' style='height:" + ((t.height || "23") + "px") + ";'><select style='width:100%;'>";
            if (t.options && t.options.length)
                for (e = 0; e < t.options.length; e++) i += "<option value='" + t.options[e].key + "'>" + t.options[e].label + "</option>";
            return i += "</select></div>"
    ...
    t.exports = function (t) {
        ...
        var r = {
            ...
            createEditors: function (n) {
                ...
                var a = [],
                    ...
                    o = {
                        ...
                        locateCell: function (t) {
                            var e = c.locateAttribute(t, n.$config.item_attribute),
                                i = c.locateAttribute(t, "data-column-name");
                            if (i) {
                        ...
                        isVisible: function () {
                            return !(!this._editor || !c.isChildOf(this._placeholder, document.body))
                        },
                        show: function (t, i) {
                            ...
                            var a = {
                                ...
                                s = n.getColumn(a.columnName),
                                o = this.getEditorConfig(s.name);
                            if (o) {
                                var l = n.$getConfig().editor_types[o.type],
                                    d = r(a.id, a.columnName);
                                n.$grid_data.appendChild(d), l.show(a.id, s, o, d), this._editor = l, this._placeholder = d, this._itemId = a.id, this._columnName = a.columnName, this._editorType = o.type;
                                var c = e.getMapping();
                                c.onShow && c.onShow(this, d, n)
                            }
                        },
                        setValue: function () {
                            var t = this.getState(),
                            ...
                            if (this.isVisible() && s.exists(this._itemId) && this.isChanged()) {
                                ...
                                if (s.exists(e)) {
                                    ...
                                    if (!1 !== this.callEvent("onBeforeSave", [o]) && this._editor.is_valid(o.newValue, o.id, o.columnName, this._placeholder)) {
                                        var l = o.newValue;
                                        "auto" != a.map_to ? (r[i] = l, "duration" == i ? r.end_date = t.calculateEndDate(r) : "end_date" == i ? r.start_date = t.calculateEndDate({
                                            start_date: r.end_date,
                                            duration: -r.duration,
                                            task: r
                                        }) : "start_date" == i && (r.end_date = t.calculateEndDate(r)), s.updateItem(e)) : this._editor.save(e, n.getColumn(i), this._placeholder), this.callEvent("onSave", [o])
                                    }
                                    this.hide()
                                }
                            } else this.hide()
                ...
                return d.mixin(o, e), d.mixin(o, i), o
            }
        };
        return d.mixin(r, e), d.mixin(r, i), r
    }
}, function (t, e, i) {
    var n = i(1),
        r = i(0),
    ...
    o.prototype = {
        init: function (t) {
            ...
            var l = s(e, this);
            l.init(), this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = i(11)(e), this._addLayers(this.$gantt), this._initEvents(), this.callEvent("onReady", [])
        },
        setSize: function (t, e) {
            this.$config.width = this.$state.width = t, this.$state.height = e;
            for (var i, n = this.getGridColumns(), r = 0, a = 0, s = n.length; a < s; a++) r += 1 * n[a].width;
        ...
        _clearLayers: function (t) {
            for (var e = this.$gantt.$services.getService("layers").getDataRender(this.$config.bind), i = 0; i < this._taskLayers.length; i++) e.removeLayer(this._taskLayers[i]);
            this._taskLayers = []
        },
            ...
            if (t.autofit || n.length) {
                ...
                if (t.autofit)
                    for (a = 0; a < r.length; a++) {
                        ...
                        r[a] += d, (c = this._getColumnWidth(e[a], t, r[a])) != r[a] && (d = c - r[a], r[a] = c), l -= d
                    } else if (n.length)
                        for (a = 0; a < n.length; a++) {
                            d = Math.round(l / (n.length - a));
                            var c, h = n[a];
                            r[h] += d, (c = this._getColumnWidth(e[h], t, r[h])) != r[h] && (d = c - r[h], r[h] = c), l -= d
                        }
        ...
        _renderGridHeader: function () {
            ...
            for (var a = [], s = 0, o = i.labels, l = e.scale_height - 1, d = 0; d < r.length; d++) {
                ...
                var f = t._sort && h.name == t._sort.name ? "<div class='gantt_sort gantt_" + t._sort.direction + "'></div>" : "",
                    g = ["gantt_grid_head_cell", "gantt_grid_head_" + h.name, c ? "gantt_last_cell" : "", n.grid_header_class(h.name, h)].join(" "),
                    p = "width:" + (u - (c ? 1 : 0)) + "px;",
                    v = h.label || o["column_" + h.name];
                v = v || "";
                var m = "<div class='" + g + "' style='" + p + "' " + t._waiAria.gridScaleCellAttrString(h, v) + " data-column-id='" + h.name + "' column_id='" + h.name + "'>" + v + f + "</div>";
                a.push(m)
            }
    ...
    function r(t) {
        var e = function (t) {
                ...
                if (t.config.scale_offset_minimal) {
                    var r = new n(t),
                        a = [r.primaryScale()].concat(t.config.subscales);
        ...
        o = function (t) {
            return this._branches = {}, this.pull = {}, this.$initItem = t.initItem, this.$parentProperty = t.parentProperty || "parent", "function" != typeof t.rootId ? this.$getRootId = function (t) {
                ...
                return this.eachParent(function (t) {
                    i = i && t.$open && !gantt.isSplitTask(t)
                }, e), !!i
            }), this
        };
    o.prototype = r.mixin({
        ...
        eachParent: function (t, e) {
            for (var i = e, n = this.getParent(i); this.exists(n);) i = this.getItem(n), t.call(this, i), n = this.getParent(i)
        },
        ...
        function e(e, a) {
            if (!t._isAllowedUnscheduledTask(e)) {
                var s = a.getItemPosition(e),
                    ...
                    l = a.$getTemplates(),
                    d = a.getItemHeight(),
                    c = t.getTaskType(e.type),
                    h = Math.floor((t.config.row_height - d) / 2);
                c == o.types.milestone && o.link_line_width > 1 && (h += 1), c == o.types.milestone && (s.left -= Math.round(d / 2), s.width = d);
                var u = document.createElement("div"),
                    _ = Math.round(s.width);
                a.$config.item_attribute && u.setAttribute(a.$config.item_attribute, e.id), o.show_progress && c != o.types.milestone && function (e, i, n, r, a) {
                ...
                (e.color || e.progressColor || e.textColor) && (g += " gantt_task_inline_color"), u.className = g;
                var p = ["left:" + s.left + "px", "top:" + (h + s.top) + "px", "height:" + d + "px", "line-height:" + Math.max(d < 30 ? d - 2 : d, 0) + "px", "width:" + _ + "px"];
                ...
                var m = t.getState();
                return t.isReadonly(e) || (o.drag_resize && !t.isSummaryTask(e) && c != o.types.milestone && r(u, "gantt_task_drag", e, function (t) {
                    var e = document.createElement("div");
                    return e.className = t, e
                }, o), o.drag_links && o.show_links && r(u, "gantt_link_control", e, function (t) {
                    var e = document.createElement("div");
                    e.className = t, e.style.cssText = ["height:" + d + "px", "line-height:" + d + "px"].join(";");
            ...
            for (var r in n)
                for (var a = i[r], s = 0; s < a.length; s++)
                    for (var o = t.getLink(a[s]), l = 0; l < n[r].length; l++)
                        if (o.type == n[r][l]) return "gantt_link_crossing";
            return ""
        }

        function r(e, i, n, r, a) {
            var s, o = t.getState(); + n.start_date >= +o.min_date && ((s = r([i, a.rtl ? "task_right" : "task_left", "task_start_date"].join(" "))).setAttribute("data-bind-property", "start_date"), e.appendChild(s)), +n.end_date <= +o.max_date && ((s = r([i, a.rtl ? "task_left" : "task_right", "task_end_date"].join(" "))).setAttribute("data-bind-property", "end_date"), e.appendChild(s))
        }
        return function (i, n) {
        ...
        return {
            ...
            _linkToTaskStore: function () {
                if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
                    var t, e = this.$gantt.$data.tasksStore,
                        i = this.$config.rowStore;
                    e["_attached_" + i.name] || (e["_attached_" + i.name] = !0, e.attachEvent("onStoreUpdated", function (e, n, r) {
                        window.requestAnimationFrame ? (cancelAnimationFrame(t), t = requestAnimationFrame(function () {
                            i.refresh()
                        })) : i.refresh()
    ...
    function l(t, e) {
        for (var i, n, r, a = 0, s = t.length - 1; a <= s;)
            if (n = +t[i = Math.floor((a + s) / 2)], r = +t[i - 1], n < e) a = i + 1;
            else {
                if (!(n > e)) {
                    for (; + t[i] == +t[i + 1];) i++;
                    return i
    ...
    o.prototype = {
        ...
        _attachLayers: function (t) {
            ...
            if (this.$config.bind) {
                ...
                for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
                    "string" == typeof (d = r[a]) && (d = this.$gantt.$ui.layers[d]), "function" == typeof d && (d = {
                        renderer: d
                    }), d.host = this;
                    var s = n.addLayer(d);
                    this._taskLayers.push(s), d.expose && (this._taskRenderer = n.getLayer(s))
                }
            ...
            if (this.$config.bindLinks) {
                ...
                for (a = 0; l && a < l.length; a++) {
                    var d;
                    "string" == typeof d && (d = this.$gantt.$ui.layers[d]), (d = l[a]).host = this;
                    var c = o.addLayer(d);
                    this._taskLayers.push(c), l[a].expose && (this._linkRenderer = o.getLayer(c))
                }
            }
        },
        ...
        _clearLayers: function (t) {
            for (var e = this.$gantt.$services.getService("layers"), i = e.getDataRender(this.$config.bind), n = e.getDataRender(this.$config.bindLinks), r = 0; r < this._taskLayers.length; r++) i.removeLayer(this._taskLayers[r]);
        ...
        _prepareScaleHtml: function (t, e, i) {
            ...
            var c = 0,
                h = t.count;
            !n.smart_scales || isNaN(e) || isNaN(i) || (c = l(t.left, e), h = l(t.left, i) + 1), d = t.css || function () {}, !t.css && n.inherit_scale_class && (d = r.scale_cell_class);
            for (var u = c; u < h && t.trace_x[u]; u++) {
                ...
                var _ = o.call(this, s),
                    ...
                    y = "";
                if (f) {
                    v = "width:" + f + "px;height:" + g + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px" : ""), y = "gantt_scale_cell" + (u == t.count - 1 ? " gantt_last_cell" : ""), (m = d.call(this, s)) && (y += " " + m);
                    var k = "<div class='" + y + "'" + this.$gantt._waiAria.getTimelineCellAttr(_) + " style='" + v + "'>" + _ + "</div>";
                    a.push(k)
                }
            }
            return a.join("")
        ...
        columnIndexByDate: function (t) {
            ...
            for (var a = l(i, e), s = +i[a]; n[s];) s = +i[++a];
            var o = this._tasks.trace_index_transition,
                d = a;
            if (!s) return o ? o[0] : 0;
            var c = (t - i[a]) / this._getColumnDuration(this._tasks, i[a]);
            return o ? o[d] + (1 - c) : d + c
        },
        ...
        getItemTop: function (t) {
            if (this.$config.rowStore) {
                ...
                if (e.getParent && e.exists(t) && e.exists(e.getParent(t))) {
                    ...
                    if (this.$gantt.isSplitTask(i)) return e.getIndexById(i.id) * this.$getConfig().row_height
                }
                return e.getIndexById(t) * this.$getConfig().row_height
            }
            return 0
        },
        getScale: function () {
    ...
    var n = i(2),
        ...
        a = (i(0), function (t) {
            ...
            return n(e, t), e.prototype.destructor = function () {
                ...
                var d = {};
                for (l = 0; l < r.length; l++) r[l].$config.group && (d[r[l].$config.group] = !0);
                for (l = 0; l < a.length; l++)(i = a[l]).$config.group && d[i.$config.group] && s(i);
                return n
                ...
                for (var s = 0; s < this._sizes.length; s++)
                    if (!(n = this.$cells[s]).$config.hidden) {
                        var o = this.$config.margin || 0;
                        "resizer" != n.$name || o || (o = -1);
                        var l = n.$view,
                            d = this._xLayout ? "marginRight" : "marginBottom";
                        s !== this.$cells.length - 1 && (l.style[d] = o + "px", this._free -= o), r = this._sizes[s], this._xLayout ? r.width || (this._gravity += r.gravity) : r.height || (this._gravity += r.gravity)
                    } for (s = 0; s < this._sizes.length; s++)
                    if (!(n = this.$cells[s]).$config.hidden) {
                        var c = (r = this._sizes[s]).width,
                            h = r.height;
                        this._xLayout ? this._calcFreeSpace(c, r, !0) : this._calcFreeSpace(h, r, !1)
                    } for (s = 0; s < this.$cells.length; s++)
                    if (!(n = this.$cells[s]).$config.hidden) {
                        r = this._sizes[s];
                        var u = void 0,
                            _ = void 0;
                        this._xLayout ? (u = this._calcSize(r.width, r, !0), _ = i - 2 * a) : (u = e - 2 * a, _ = this._calcSize(r.height, r, !1)), n.setSize(u, _)
                    }
            }, e
        }(i(6)));
    t.exports = a
    ...
    t.exports = function (t) {
        ...
        for (var n = ["message", "alert", "confirm", "modalbox", "uid", "copy", "mixin", "defined", "bind", "assert"], r = [], a = 0; a < n.length; a++) window.dhtmlx[n[a]] || (r.push(n[a]), dhtmlx[n[a]] = i(n[a]));
        t.attachEvent("onDestroy", function () {
            for (var t = 0; t < r.length; t++) delete window.dhtmlx[r[t]];
            r = null
    ...
    t.exports = function (t) {
        var e = i(20);
        t.assert = i(33)(t), t.init = function (e, i, r) {
            var a;
            i && r && (this.config.start_date = this._min_date = new Date(i), this.config.end_date = this._max_date = new Date(r)), this.date.init(), this.config.scroll_size || (this.config.scroll_size = n.getScrollSize() || 1), t.event(window, "resize", function () {
            ...
            return "split" == e.render && t.hasChild(e.id)
    ...
    t.exports = function (t) {
        ...
        t._touch_events = function (n, r, a) {
            for (var s, o = 0, l = !1, d = !1, c = null, h = null, u = null, _ = 0; _ < i.length; _++) t.eventRemove(i[_][0], i[_][1], i[_][2]);
            (i = []).push([t.$container, n[0], function (i) {
                ...
                if (!a(i) && l) {
                    ...
                    if (!t._prevent_touch_scroll) {
                        if (u && c) {
                            var _ = c.pageX - u.pageX,
                                g = c.pageY - u.pageY;
                            if (!d && (Math.abs(_) > 5 || Math.abs(g) > 5) && (t._touch_scroll_active = d = !0, o = 0, s = t.getScrollState()), d) {
                                t.scrollTo(s.x + _, s.y + g);
                                var p = t.getScrollState();
                                if (s.x != p.x && g > 2 * _ || s.y != p.y && _ > 2 * g) return f(i)
                            }
                        }
                        return f(i)
                    }
                ...
                if (!a(i))
                    if (i.touches && i.touches.length > 1) l = !1;
                        ...
                        c = r(i), t._locate_css(c, "gantt_hor_scroll") || t._locate_css(c, "gantt_ver_scroll") || (l = !0);
                        var n = e();
                        h = setTimeout(function () {
                            var e = t.locate(c);
                            n && e && !t._locate_css(c, "gantt_link_control") && !t._locate_css(c, "gantt_grid_data") && (n.on_mouse_down(c), n.drag && n.drag.start_drag && (! function (e) {
                            ...
                            }(e), n._start_dnd(c), t._touch_drag = !0, t.refreshTask(e), t._touch_feedback())), h = null
                        }, t.config.touch_drag)
                    }
                ...
                if (!a(i)) {
                    ...
                    var n = r(i),
                        s = e();
                    if (s && s.on_mouse_up(n), u && (t.refreshTask(t.locate(u)), u.parentNode && (u.parentNode.removeChild(u), t._touch_feedback())), t._touch_scroll_active = l = d = !1, u = null, c && o) {
                        var _ = new Date;
                        if (_ - o < 500) t.$services.getService("mouseEvents").onDoubleClick(c), f(i);
                        else o = _
                    } else o = new Date
                }
            }]);
            for (_ = 0; _ < i.length; _++) t.event(i[_][0], i[_][1], i[_][2]);
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (i) {
            ...
            for (var o in n) !1 == !s(o, n[o]) && a.push({
                key: n[o],
                label: r["type_" + o]
            });
            i.options = a;
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (e) {
            var i = "<div class='gantt_time_selects'>" + t.form_blocks.getTimePicker.call(this, e) + "</div>",
                ...
                s = "<div class='gantt_duration' " + r + "><input type='button' class='gantt_duration_dec' value='âˆ’'" + a + "><input type='text' value='5' class='gantt_duration_value'" + a + " " + t._waiAria.lightboxDurationInputAttrString(e) + "><input type='button' class='gantt_duration_inc' value='+'" + a + "> " + n + " <span></span></div>";
            return "<div style='height:" + (e.height || 30) + "px;padding-top:0px;font-size:inherit;' class='gantt_section_time'>" + i + " " + s + "</div>"
        }, r.prototype.set_value = function (e, i, n, r) {
            var o, l, d, c, h = r,
                u = e.getElementsByTagName("select"),
                _ = e.getElementsByTagName("input"),
                f = _[1],
                g = [_[0], _[2]],
            ...
            }, this), f.onchange = t.bind(m, this), "string" == typeof (o = t._resolve_default_mapping(r)) && (o = {
                start_date: o
            }), l = n[o.start_date] || new Date, d = n[o.end_date] || t.calculateEndDate({
                start_date: l,
                duration: 1,
                task: n
            }), c = Math.round(n[o.duration]) || t.calculateDuration({
                start_date: l,
                end_date: d,
                task: n
            }), t.form_blocks._fill_lightbox_select(u, 0, l, v, h), f.value = c, m()
    ...
    t.exports = function (t) {
        ...
        function _(e, i, n) {
            ...
            switch (n.timeFormat[i]) {
                case "%Y":
                    for (e._time_format_order[2] = i, e._time_format_order.size++, e.year_range && (isNaN(e.year_range) ? e.year_range.push && (s = e.year_range[0], o = e.year_range[1]) : r = e.year_range), r = r || 10, a = a || Math.floor(r / 2), s = s || n.date.getFullYear() - a, o = o || s + r, l = s; l < o; l++) c += "<option value='" + l + "'>" + l + "</option>";
                    break;
                case "%m":
                    for (e._time_format_order[1] = i, e._time_format_order.size++, l = 0; l < 12; l++) c += "<option value='" + l + "'>" + t.locale.date.month_full[l] + "</option>";
                    break;
                case "%d":
                    for (e._time_format_order[0] = i, e._time_format_order.size++, l = 1; l < 32; l++) c += "<option value='" + l + "'>" + l + "</option>";
                    break;
                case "%H:%i":
                    for (e._time_format_order[3] = i, e._time_format_order.size++, l = n.first, d = n.date.getDate(), e._time_values = []; l < n.last;) c += "<option value='" + l + "'>" + t.templates.time_picker(n.date) + "</option>", e._time_values.push(l), n.date.setTime(n.date.valueOf() + 60 * t._get_timepicker_step() * 1e3), l = 24 * (n.date.getDate() != d ? 1 : 0) * 60 + 60 * n.date.getHours() + n.date.getMinutes()
            }
            return c
        }
        t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
            ...
            t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function () {
                ...
                if (n.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [n.className, n, i]);
                    ...
                    if (-1 != s.indexOf("gantt_custom_button"))
                        if (-1 != s.indexOf("gantt_custom_button_"))
            ...
            getTimePicker: function (e, i) {
                ...
                for (e._time_format_order = {
                        size: 0
                    }, t.config.limit_time_select && (d.first = 60 * l.first_hour, d.last = 60 * l.last_hour + 1, d.date.setHours(l.first_hour)), r = 0; r < d.timeFormat.length; r++) r > 0 && (o += " "), (a = _(e, r, d)) && (s = t._waiAria.lightboxSelectAttrString(d.timeFormat[r]), o += "<select " + (e.readonly ? "disabled='disabled'" : "") + (i ? " style='display:none' " : "") + s + ">" + a + "</select>");
                return o
            },
    ...
    t.exports = function (t) {
        t.isUnscheduledTask = function (t) {
            ...
            var i = this.getTask(e),
                n = (this.getTaskType(i.type), i.start_date ? i.start_date.valueOf() : null),
            ...
            var r, a, s, o = e.date,
                ...
                d = e.unit;
            if (!i) return o;
            if (d == i.unit && l == i.step && +o >= +i.min_date && +o <= +i.max_date) s = Math.floor(t.columnIndexByDate(o)), i.trace_x[s] || (s -= 1, i.rtl && (s = 0)), a = new Date(i.trace_x[s]), r = t.date.add(a, l, d);
            else {
                for (s = Math.floor(t.columnIndexByDate(o)), r = t.date[d + "_start"](new Date(i.min_date)), i.trace_x[s] && (r = t.date[d + "_start"](i.trace_x[s])); + r < +o;) {
                    var c = (r = t.date[d + "_start"](t.date.add(r, l, d))).getTimezoneOffset();
                    r = t._correct_dst_change(r, c, r, d), t.date[d + "_start"] && (r = t.date[d + "_start"](r))
                }
                a = t.date.add(r, -1 * l, d)
            }
    ...
    a.prototype = {
        ...
        _getWorkUnitsBetweenGeneric: function (t, e, i, n) {
            ...
            for (var _ = !1; a.valueOf() < s.valueOf();) _ = (c = this._nextDate(a, i, n)).valueOf() > s.valueOf(), this._isWorkTime(a, i) && ((h || u && _) && (o = r[i + "_start"](new Date(a)), l = r.add(o, n, i)), h ? (h = !1, c = this._nextDate(o, i, n), d += (l.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : u && _ ? (u = !1, d += (s.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : d++), a = c;
            return d
        },
        ...
        _getClosestWorkTime: function (t) {
            ...
            var e = t.unit,
                i = this.$gantt.date[e + "_start"](new Date(t.date)),
                n = new Date(i),
                r = new Date(i),
                a = !0,
                s = 0,
    ...
    s.prototype = {
        ...
        mergeCalendars: function () {
            ...
            for (var a = 0; a < n.length; a++)
                for (var s in n[a].worktime.dates) + s > 1e4 && (i = this._getDayHoursForMultiple(n, new Date(+s)), e.worktime.dates[s] = i);
            return e
        },
        ...
        createCalendar: function (t) {
            ...
            return n.mixin(o, s), o._tryChangeCalendarSettings(function () {}) ? o : null
        },
        ...
        t.load = function (e, i, n) {
            ...
            _getCollections: function (e) {
                for (var i = {}, n = t.ajax.xpath("//coll_options", e), r = 0; r < n.length; r++)
                    for (var a = i[n[r].getAttribute("for")] = [], s = t.ajax.xpath(".//item", n[r]), o = 0; o < s.length; o++) {
                        for (var l = s[o].attributes, d = {
                                key: s[o].getAttribute("value"),
                                label: s[o].getAttribute("label")
                            }, c = 0; c < l.length; c++) {
                            var h = l[c];
                            "value" != h.nodeName && "label" != h.nodeName && (d[h.nodeName] = h.nodeValue)
                        }
                        a.push(d)
                    }
                return i
    ...
    var n = i(13);
    t.exports = function (t) {
        i(67)(t), n.prototype.getGridColumns = function () {
    ...
    t.exports = function (t) {
        ...
        function s(e) {
            ...
            var i = t.getTask(e),
                n = t.config.types,
                r = t.hasChild(i.id) ? n.project : n.task,
                a = t.getTaskType(i.type);
            (a == n.task && r == n.project || a == n.project && r == n.task) && (i.type = r, t.updateTask(e))
        }
        ...
        t.attachEvent("onParse", e(function () {
        ...
        })), t.attachEvent("onAfterTaskAdd", e(i)), t.attachEvent("onAfterTaskUpdate", e(i)), t.attachEvent("onBeforeTaskDelete", e(function (e, i) {
            return n = t.getParent(e), !0
        })), t.attachEvent("onAfterTaskDelete", e(function (t, e) {
            o(n)
        })), t.attachEvent("onRowDragStart", e(function (e, i, n) {
            return r = t.getParent(e), !0
            ...
            document.querySelector(".gantt_drag_marker") || (o(a), i(t))
        }))
    }
}, function (t, e) {
    t.exports = function (t) {
        ...
        t.config.types.placeholder = "placeholder", t.attachEvent("onGanttReady", function () {
            t.attachEvent("onBeforeDataRender", e(i)), t.attachEvent("onAfterTaskUpdate", e(r)), t.attachEvent("onAfterTaskAdd", e(function (e, i) {
    ...
    function i(t) {
        ...
        function i(e, i) {
            ...
            }(e) : i instanceof Array ? n(e, i) : n(e, [i])
        }

        function n(i, n) {
            for (var r, a = n.join("_") + "_" + i, s = {}, o = 0; o < n.length; o++) s[n[o]] = !0;
            return e[a] ? r = e[a] : (r = e[a] = [], t.eachTask(function (e) {
                s[e[i]] && e.type != t.config.types.project && r.push(e)
            })), r
        }

        function r(n, r, a, s) {
            var o = [n, r, a.unit, a.step].join("_");
            return e[o] ? e[o] : e[o] = function (e, n, r, a) {
                for (var s = i(e, n), o = r.unit, l = {}, d = 0; d < s.length; d++)
                    for (var c = s[d], h = t.date[o + "_start"](new Date(c.start_date)); h < c.end_date;) {
                        var u = h;
                        if (h = t.date.add(h, 1, o), t.isWorkTime({
                                date: u,
                                task: c,
                                unit: o
                            })) {
                ...
                for (var f, g, p = [], v = a.$getConfig(), d = 0; d < r.trace_x.length; d++) f = new Date(r.trace_x[d]), g = t.date.add(f, 1, o), ((s = l[f.valueOf()] || []).length || v.resource_render_empty_cells) && p.push({
                    start_date: f,
                    end_date: g,
                    tasks: s
                });
        ...
        return t.$data.tasksStore.attachEvent("onStoreUpdated", function () {
            ...
            renderLine: function (t, e) {
                for (var i = e.$getConfig(), n = e.$getTemplates(), a = r(i.resource_property, t.id, e.getScale(), e), s = [], o = 0; o < a.length; o++) {
                    var l = a[o],
                ...
                var _ = null;
                if (s.length)
                    for (_ = document.createElement("div"), o = 0; o < s.length; o++) _.appendChild(s[o]);
                return _
            },
            filterTasks: i
        }
    ...
    t.exports = function (t) {
        var e = i(t);
        t.getTaskBy = e.filterTasks, t.$ui.layers.resourceRow = e.renderLine, t.config.resource_property = "owner_id", t.config.resource_store = "resource", t.config.resource_render_empty_cells = !1, t.templates.resource_cell_class = function (t, e, i, n) {
        ...
        return t.$services.getService("state").registerProvider("batchUpdate", function () {
            ...
            function (t, e) {
                if (i) s(t);
                    ...
                    for (var c in function (t) {
                            for (var e in t) n.call(this, e, t[e])
                        }.call(this, d), i = !0, this.callEvent("onBeforeBatchUpdate", []), s(t), this.callEvent("onAfterBatchUpdate", []), a.call(this), l) this.resetProjectDates(l[c]);
    ...
    t.exports = function (t) {
        ...
        function _(e) {
            if (l && (clearTimeout(l), l = null), e) {
                ...
                i && i < 10 && (i = 10), l = setTimeout(function () {
                    s = setInterval(p, i || a), n.getNodePosition(h())
                }, t.config.autoscroll_delay || r)
            }
        }

        function f(t) {
            t ? (_(!0), d.started || (d.x = c.x, d.y = c.y, d.started = !0)) : (s && (clearInterval(s), s = null), _(!1), d.started = !1)
        }
        ...
        function p() {
            if (!u()) return f(!1), !1;
            var e = n.getNodePosition(h()),
                r = c.x - e.x,
                a = c.y - e.y,
                s = o ? 0 : v(r, e.width, d.x - e.x),
                l = v(a, e.height, d.y - e.y),
                _ = t.getScrollState(),
                g = _.y,
                p = _.inner_height,
                m = _.height,
                ...
                k = _.inner_width,
                b = _.width;
            l && !p ? l = 0 : l < 0 && !g ? l = 0 : l > 0 && g + p >= m + 2 && (l = 0), s && !k ? s = 0 : s < 0 && !y ? s = 0 : s > 0 && y + k >= b && (s = 0);
            var $ = t.config.autoscroll_step;
            $ && $ < 2 && ($ = 2), s *= $ || i, l *= $ || i, (s || l) && function (e, i) {
    ...
    t.exports = function (t) {
        for (var e = [i(77), i(76), i(75), i(74), i(73), i(72), i(71), i(70)], n = 0; n < e.length; n++) e[n] && e[n](t)
    }
}, function (t, e, i) {
    var n = i(0),
        r = i(3),
    ...
    a.prototype = {
        ...
        _sendData: function (t, e) {
            if (t) {
                ...
                if ("GET" == this._tMode) r.query({
                    url: s + r.urlSeparator(s) + this.serialize(t, e),
                    method: "GET",
                    callback: n,
                    headers: this._headers
                });
                else if ("POST" == this._tMode) r.query({
                    url: s,
                    method: "POST",
                    headers: this._headers,
        ...
        sendAllData: function () {
            if (this.updatedRows.length) {
                ...
                if (this._tSend) this._sendData(this._getAllData());
                    ...
                    for (e = 0; e < this.updatedRows.length; e++)
        ...
        afterUpdate: function (t, e, i) {
            ...
            if (!d.length) return this.cleanUpdate(i);
    ...
    t.exports = function (t, e) {
        e.attachEvent("insertCallback", n.bind(r, t)), e.attachEvent("updateCallback", n.bind(a, t)), e.attachEvent("deleteCallback", n.bind(a, t))
    }
}, function (t, e, i) {
    var n = i(80),
        r = i(7),
    ...
    t.exports = function (t) {
        var e;
        t.dataProcessor = i(79);
        var s = [];
        t._dp_init = function (o) {
            t.assert(!this._dp, "The dataProcessor is already attached to this gantt instance"), o.setTransactionMode("POST", !0), o.serverProcessor += (-1 != o.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", o._serverProcessor = o.serverProcessor, o.$gantt = this, o.styles = {
                    ...
                    error: "gantt_error",
                    clear: ""
                }, o._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"],
                function (t, i) {
                    i.setGanttMode = function (t) {
                        ...
                        var n = i._ganttMode,
                            r = t.filePath;
                        n = "REST" != this._tMode ? -1 != r.indexOf("gantt_mode=links") ? "links" : "tasks" : r.indexOf("/link") > r.indexOf("/task") ? "links" : "tasks", i.setGanttMode(n);
                        var a = e.apply(i, arguments);
                        return i.setGanttMode(n), a
                    }, i._getRowData = t.bind(function (e, n) {
                        var a;
                        a = "tasks" == i._ganttMode ? this.isTaskExists(e) ? this.getTask(e) : {
                            id: e
                        ...
                        for (var o in a)
                            ...
                            } var d = this._get_task_timing_mode(a);
                        return d.$no_start && (a.start_date = "", a.duration = ""), d.$no_end && (a.end_date = "", a.duration = ""), s[i.action_param] = this.getUserData(e, i.action_param), s
                    }, t)
                }.call(this, t, o),
                function (t, e) {
                ...
                function (t, e) {
                    ...
                    s.push(this.attachEvent("onAfterTaskAdd", function (t, i) {
                        e.setGanttMode("tasks"), e.setUpdated(t, !0, "inserted")
                    })), s.push(this.attachEvent("onAfterTaskUpdate", function (i, n) {
                        e.setGanttMode("tasks"), e.setUpdated(i, !0), t._sendTaskOrder(i, n)
                    }));
                    var r = i(19),
                        a = {};
                    s.push(this.attachEvent("onBeforeTaskDelete", function (e, i) {
                        return !t.config.cascade_delete || (a[e] = {
                            tasks: r.getSubtreeTasks(t, e),
                            links: r.getSubtreeLinks(t, e)
                        }, !0)
                    })), s.push(this.attachEvent("onAfterTaskDelete", function (i, r) {
                        if (e.setGanttMode("tasks"), !n(i)) {
                            if (t.config.cascade_delete && a[i]) {
                                var s = e.updateMode;
                                e.setUpdateMode("off");
                                var o = a[i];
                                for (var l in o.tasks) n(l) || e.setUpdated(l, !0, "deleted");
                                for (var l in e.setGanttMode("links"), o.links) n(l) || e.setUpdated(l, !0, "deleted");
                                a[i] = null, "off" != s && e.sendAllData(), e.setGanttMode("tasks"), e.setUpdateMode(s)
                            }
                            e.setUpdated(i, !0, "deleted"), "off" == e.updateMode || e._tSend || e.sendAllData()
                        }
                    })), s.push(this.attachEvent("onAfterLinkUpdate", function (t, i) {
                        e.setGanttMode("links"), e.setUpdated(t, !0)
                    })), s.push(this.attachEvent("onAfterLinkAdd", function (t, i) {
                        e.setGanttMode("links"), e.setUpdated(t, !0, "inserted")
                    })), s.push(this.attachEvent("onAfterLinkDelete", function (t, i) {
                        e.setGanttMode("links"), !n(t) && e.setUpdated(t, !0, "deleted")
                    })), s.push(this.attachEvent("onRowDragEnd", function (e, i) {
                        t._sendTaskOrder(e, t.getTask(e))
                    }));
                    var o = null,
                        l = null;
                    s.push(this.attachEvent("onTaskIdChange", function (i, n) {
                        if (e._waitMode) {
                            ...
                            if (d.length)
                                for (l = l || {}, a = 0; a < d.length; a++) {
                                    var c = this.getLink(d[a]);
                                    l[c.id] = c
                                }
                        }
                ...
                }.call(this, t, o), o.attachEvent("onDestroy", function () {
                    ! function (t, i) {
                        delete i.$gantt, delete i.setGanttMode, delete i._getRowData, i.afterUpdate = e, delete t._dp, delete t._change_id, delete t._row_style, delete t._delete_task, delete t._sendTaskOrder, a.forEach(s, function (e) {
                            t.detachEvent(e)
                        }), s = []
                    }(t, o)
                }), n(t, o)
    ...
    t.exports = {
        bindDataStore: function (t, e) {
            ...
            i.attachEvent("onStoreUpdated", function (s, o, l) {
                if (!a(e)) {
                    var d = e.$services.getService("layers").getDataRender(t);
                    d && (s && "move" != l && "delete" != l ? (i.callEvent("onBeforeRefreshItem", [o.id]), n(o.id, d), i.callEvent("onAfterRefreshItem", [o.id])) : (i.callEvent("onBeforeRefreshAll", []), r(d), i.callEvent("onAfterRefreshAll", [])))
                }
    ...
    t.exports = function (t) {
        ...
        return t._removeItemInner = function (t) {
            return e == t && (e = null), i.apply(this, arguments)
            ...
            unselect: function (t) {
                (t = t || e) && (e = null, this._skip_refresh || (this.refresh(t), this.callEvent("onAfterUnselect", [t])))
            }
        }
    }
}, function (t, e, i) {
    ...
    var h = function () {
        return {
            createDatastore: function (t) {
                ...
                if (this.mixin(n, l(n)), t.name) {
                    ...
                    r || (r = [], this.$services.setService("datastores", function () {
                        return r
                    })), r.push(t.name), d.bindDataStore(t.name, this)
                }
                return n
            },
            ...
            refreshData: function () {
                ...
                for (var e = c.call(this), i = 0; i < e.length; i++) e[i].refresh();
            ...
            refreshTask: function (t, e) {
                ...
                } else gantt.isTaskExists(t) && gantt.isTaskExists(gantt.getParent(t)) && gantt.refreshTask(gantt.getParent(t))
            },
            ...
            clearAll: function () {
                for (var t = c.call(this), e = 0; e < t.length; e++) t[e].clearAll();
    ...
    t.exports = function (t) {
        ...
        function h() {
            ...
            for (n = 0, r = a.length; n < r; n++) d(a[n])
        }
        ...
        s.attachEvent("onBeforeRefreshAll", function () {
                ...
                c(t.mixin({
                    id: e
                }, t.$data.linksStore.getItem(i))), d(t.$data.linksStore.getItem(i))
            ...
            function () {
                ...
                t.attachEvent("onBeforeTaskDelete", function (i, r) {
                    ...
                    n[e] && t.$data.linksStore.silent(function () {
                        for (var i in n[e]) t.$data.linksStore.removeItem(i), c(n[e][i]);
                        n[e] = null
                    })
                })
    ...
    t.exports = function () {
        ...
        return {
            ...
            getRowTop: function (i) {
                var n = this,
                    s = a.call(n, t, "getRowTop", [i], function () {
            ...
            getTaskTop: function (i) {
                var n = this,
                    s = a.call(n, t, "getItemTop", [i], function () {
                    ...
                    this._legacyGridResizerClass(e), e.attachEvent("onBeforeResize", function () {
                        ...
                        if (a) {
                            ...
                            if (a.$config.hidden = a.$parent.$config.hidden = !s, !a.$config.hidden) {
                                ...
                                } else a.$parent._setContentSize(a.$config.width, a.$config.height);
    ...
    var n = i(1),
        r = function (t, e) {
            ...
            var d = e.$services,
                c = d.getService("state"),
                h = d.getService("dnd");
            c.registerProvider("linksDnD", l);
            var u = new h(t.$task_bars, {
                sensitivity: 0,
                updates_per_second: 60
            });

            function _(i, n, r, a, s) {
                ...
                return r = r || 0, a.rtl && (r *= -1), l.x += (n ? -1 : 1) * r - d, l
            }
            ...
            u.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
                ...
                if (g(), e.getState().drag_id) return !1;
                if (n.locateClassName(a, "gantt_link_point")) {
                    n.locateClassName(a, "task_start_date") && (o = !0);
                    var l = e.locate(r);
                    s = l;
                    var d = e.getTask(l);
                    if (e.isReadonly(d)) return g(), !1;
                    return this._dir_start = _(d, !!o, 0, t.$getConfig(), !0), !0
                }
                return !1
                ...
                var h = !!n.locateClassName(o, "gantt_link_control"),
                    g = r,
                    v = i,
                    m = a,
                    y = e.locate(o),
                    k = !0;
                if (h && (k = !n.locateClassName(o, "task_end_date"), h = !!y), r = y, i = h, a = k, h) {
                    var b = e.getTask(y),
                        $ = t.$getConfig(),
                        x = n.locateClassName(o, "gantt_link_control"),
                        w = 0;
                    x && (w = Math.floor(x.offsetWidth / 2)), this._dir_end = _(b, !!a, w, $)
                } else this._dir_end = n.getRelativeEventPosition(o, t.$task_data);
                var S = !(v == h && g == y && m == k);
                return S && (g && e.refreshTask(g, !1), y && e.refreshTask(y, !1)), S && f(d.marker),
                    function (i, n, r, a) {
                        var s = function () {
                            ...
                            o = l(),
                            d = ["gantt_link_direction"];
                        e.templates.link_direction_class && d.push(e.templates.link_direction_class(o.link_source_id, o.link_from_start, o.link_target_id, o.link_to_start));
                        var c = Math.sqrt(Math.pow(r - i, 2) + Math.pow(a - n, 2));
                        if (!(c = Math.max(0, c - 3))) return;
                        s.className = d.join(" ");
                        var h = (a - n) / (r - i),
                            _ = Math.atan(h);
                        2 == p(i, r, n, a) ? _ += Math.PI : 3 == p(i, r, n, a) && (_ -= Math.PI);
                        var f = Math.sin(_),
                            g = Math.cos(_),
                            v = Math.round(n),
                            m = Math.round(i),
                            y = ["-webkit-transform: rotate(" + _ + "rad)", "-moz-transform: rotate(" + _ + "rad)", "-ms-transform: rotate(" + _ + "rad)", "-o-transform: rotate(" + _ + "rad)", "transform: rotate(" + _ + "rad)", "width:" + Math.round(c) + "px"];
                        if (-1 != window.navigator.userAgent.indexOf("MSIE 8.0")) {
                            ...
                            var k = Math.abs(Math.round(i - r)),
                                b = Math.abs(Math.round(a - n));
                            switch (p(i, r, n, a)) {
                                case 1:
                                    v -= b;
                                    break;
                ...
                g(), e.config.touch ? e.refreshData() : (t.link_source_id && e.refreshTask(t.link_source_id, !1), t.link_target_id && e.refreshTask(t.link_target_id, !1)), u._direction && (u._direction.parentNode && u._direction.parentNode.removeChild(u._direction), u._direction = null)
            }, this))
        };
    t.exports = {
                        ...
                        return {
                            ...
                            init: function () {
                                ...
                                for (var a in this._events)
                                    for (var s in t) this._events[a][s] = n[a];
                            ...
                            _update_on_move: function (i) {
                                ...
                                if (a.mode) {
                                    ...
                                    if (this._handlers[a.mode]) {
                                        if (e.isSummaryTask(c) && e.config.drag_project && a.mode == s.drag_mode.move) {
                                            var h = {};
                                            h[a.id] = r.copy(a);
                                            var u = this._find_max_shift(r.mixin(h, this.dragMultiple), d);
                                            for (var _ in void 0 !== u && (d = u), this._update_item_on_move(d, a.id, a.mode, a, i), this.dragMultiple) {
                                                var f = this.dragMultiple[_];
                                                this._update_item_on_move(d, f.id, f.mode, f, i)
                                            }
                                        } else this._update_item_on_move(d, a.id, a.mode, a, i);
                                ...
                                if (2 != i.button || void 0 === i.button) {
                                    ...
                                    if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
                                        ...
                                        var l = n.getClassName(r),
                                            d = this._get_drag_mode(l, r);
                                        if (!l || !d) return r.parentNode ? this.on_mouse_down(i, r.parentNode) : void 0;
                                        if (d)
                                            if (d.mode && d.mode != a.drag_mode.ignore && a["drag_" + d.mode]) {
                                                if (s = e.locate(r), o = e.copy(e.getTask(s) || {}), e.isReadonly(o)) return this.clear_drag_state(), !1;
                                                if (e.isSummaryTask(o) && !a.drag_project && d.mode != a.drag_mode.progress) return void this.clear_drag_state();
                                                d.id = s;
                                                var c = n.getRelativeEventPosition(i, e.$task_data);
                            ...
                            on_mouse_up: function (i) {
                                ...
                                if (n.mode && n.id) {
                                    ...
                                    if (this._finalize_mouse_up(n.id, r, n, i), e.isSummaryTask(a) && r.drag_project && n.mode == r.drag_mode.move)
                                        for (var o in s) this._finalize_mouse_up(s[o].id, r, s[o], i)
                                }
    ...
    var n = i(0),
        ...
        o = function (t) {
            ...
            return {
                onCreated: function (e) {
                    var s = e.$config;
                    s.bind = n.defined(s.bind) ? s.bind : "task", s.bindLinks = n.defined(s.bindLinks) ? s.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = i(11)(t)
                },
                onInitialized: function (e) {
            ...
            if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                ...
                t.defined(e.$getConfig().dnd_sensitivity) && (r.config.sensitivity = e.$getConfig().dnd_sensitivity), r.attachEvent("onBeforeDragStart", t.bind(function (i, n) {
                    ...
                    var l = o.getAttribute(e.$config.item_attribute),
                        d = s().getItem(l);
                    return !t.isReadonly(d) && (r.config.initial_open_state = d.$open, !!t.callEvent("onRowDragStart", [l, n.target || n.srcElement, n]) && void 0)
                    ...
                    var l = s(),
                        d = l.getItem(r.config.id);
                    r.config.index = l.getBranchIndex(r.config.id), r.config.parent = d.parent, d.$open = !1, d.$transparent = !0, this.refreshData()
                    ...
                    var i = n.getNodePosition(e.$grid_data),
                        ...
                        l = e.$getConfig();
                    o < i.y && (o = i.y);
                    var d = r.countVisible() * l.row_height;
                    return o > i.y + d - l.row_height && (o = i.y + d - l.row_height), i.x = a, i.y = o, i
                    ...
                    var d = l.getItem(r.config.id),
                        c = r._getTargetY(i),
                        h = r._getTaskByY(c, l.getIndexById(d.id));

                    function u(t, e) {
                        return !l.isChildOf(_.id, e.id) && (t.$level == e.$level || o.order_branch_free)
                    }
                    if (l.exists(h) || (h = r.lastTaskOfLevel(o.order_branch_free ? d.$level : 0)) == r.config.id && (h = null), l.exists(h)) {
                        var _ = l.getItem(h);
                        if (l.getIndexById(_.id) * o.row_height + o.row_height / 2 < c) {
                            var f = l.getIndexById(_.id),
                                g = l.getNext(_.id),
                                p = l.getItem(g);
                            if (p) {
                                if (p.id == d.id) return o.order_branch_free && l.isChildOf(d.id, _.id) && 1 == l.getChildren(_.id).length ? void l.move(d.id, l.getBranchIndex(_.id) + 1, l.getParent(_.id)) : void 0;
                                _ = p
                            } else if (g = l.getIdByIndex(f), u(p = l.getItem(g), d) && p.id != d.id) return void l.move(d.id, -1, l.getParent(p.id))
                        } else if (o.order_branch_free && _.id != d.id && u(_, d)) {
                            if (!l.hasChild(_.id)) return _.$open = !0, void l.move(d.id, -1, _.id);
                            if (l.getIndexById(_.id) || o.row_height / 3 < c) return
                        }
                        f = l.getIndexById(_.id);
                        for (var v = l.getIdByIndex(f - 1), m = l.getItem(v), y = 1;
                            (!m || m.id == _.id) && f - y >= 0;) v = l.getIdByIndex(f - y), m = l.getItem(v), y++;
                        if (d.id == _.id) return;
                        u(_, d) && d.id != _.id ? l.move(d.id, 0, 0, _.id) : _.$level != d.$level - 1 || l.getChildren(_.id).length ? m && u(m, d) && d.id != m.id && l.move(d.id, -1, l.getParent(m.id)) : l.move(d.id, 0, _.id)
                    }
                    return !0
            ...
            return {
                onCreated: function (e) {
                    e.$config = n.mixin(e.$config, {
                        bind: "task"
                    }), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(11)(t)
                },
                onInitialized: function (e) {
                    e.$getConfig().order_branch && r.init(e.$gantt, e), this.initEvents(e, t), "grid" == e.$config.id && this.extendDom(e)
                },
                onDestroyed: function (e) {
                    t.ext.inlineEditors.destructor(), this.clearEvents(e, t)
                },
    ...
    t.exports = function (t) {
        return function (e, i) {
            var r = i.getGridColumns(),
                a = i.$getConfig(),
                s = i.$getTemplates(),
                o = i.$config.rowStore;
            a.rtl && (r = r.reverse());
            for (var l = [], d = 0; d < r.length; d++) {
                var c, h, u, _ = d == r.length - 1,
                    f = r[d];
                ...
                var m = "width:" + (f.width - (_ ? 1 : 0)) + "px;";
                this.defined(f.align) && (m += "text-align:" + f.align + ";");
                var y = t._waiAria.gridCellAttrString(f, u);
                p.push(h), a.rtl && (p = p.reverse()), c = "<div class='" + g + "' data-column-index='" + d + "' data-column-name='" + f.name + "' style='" + m + "' " + y + ">" + p.join("") + "</div>", l.push(c)
            }
            if (g = t.getGlobalTaskIndex(e.id) % 2 == 0 ? "" : " odd", g += e.$transparent ? " gantt_transparent" : "", g += e.$dataprocessor_class ? " " + e.$dataprocessor_class : "", s.grid_row_class) {
                var k = s.grid_row_class.call(t, e.start_date, e.end_date, e);
                k && (g += " " + k)
            }
            o.getSelectedId() == e.id && (g += " gantt_selected");
            var b = document.createElement("div");
            b.className = "gantt_row" + g + " gantt_row_" + t.getTaskType(e.type);
            var $ = i.getItemHeight();
    ...
    t.exports = function (t) {
            ...
            i = {
                ...
                get_points: function (i, n) {
                    ...
                    var d = 2 * a.link_arrow_size,
                        c = this.get_line_type(i, n.$getConfig()),
                        h = r.e_x > r.x;
                    if (c.from_start && c.to_start) this.point_to(l.left, d), h ? (this.point_to(l.down, s), this.point_to(l.right, o)) : (this.point_to(l.right, o), this.point_to(l.down, s)), this.point_to(l.right, d);
                    else if (!c.from_start && c.to_start)
                        if (h = r.e_x > r.x + 2 * d, this.point_to(l.right, d), h) o -= d, this.point_to(l.down, s), this.point_to(l.right, o);
                        else {
                            o -= 2 * d;
                            var u = s > 0 ? 1 : -1;
                    ...
                    else c.from_start || c.to_start ? c.from_start && !c.to_start && (h = r.e_x > r.x - 2 * d, this.point_to(l.left, d), h ? (o += 2 * d, u = s > 0 ? 1 : -1, this.point_to(l.down, u * (a.row_height / 2)), this.point_to(l.right, o), this.point_to(l.down, u * (Math.abs(s) - a.row_height / 2)), this.point_to(l.left, d)) : (o += d, this.point_to(l.down, s), this.point_to(l.right, o))) : (this.point_to(l.right, d), h ? (this.point_to(l.right, o), this.point_to(l.down, s)) : (this.point_to(l.down, s), this.point_to(l.right, o)), this.point_to(l.left, d));
                    return this.path
                },
        ...
        return function (n, r) {
            ...
            u && (h += " " + u), a.highlight_critical_path && t.isCriticalLink && t.isCriticalLink(n) && (h += " gantt_critical_link"), c.className = h, r.$config.link_attribute && c.setAttribute(r.$config.link_attribute, n.id);
            for (var _ = 0; _ < d.length; _++) {
                _ == d.length - 1 && (d[_].size -= a.link_arrow_size);
                var f = e.render_line(d[_], d[_ + 1], r);
                n.color && (f.firstChild.style.backgroundColor = n.color), c.appendChild(f)
            }
            var g = d[d.length - 1].direction,
                p = function (t, i, n) {
                    var r = n.$getConfig(),
                        ...
                        l = r.link_arrow_size,
                        d = r.row_height,
                        c = "gantt_link_arrow gantt_link_arrow_" + i;
                    switch (i) {
                        case e.dirs.right:
                            s -= (l - d) / 2, o -= l;
                            break;
            ...
            return n.color && (p.style.borderColor = n.color), c.appendChild(p), t._waiAria.linkAttr(n, c), c
        }
    }
}, function (t, e) {
    t.exports = function (t) {
            ...
            if (n.show_task_cells)
                for (var l = 0; l < s; l++) {
                    ...
                    if (d > 0) {
                        ...
                        h.style.width = d + "px", c = "gantt_task_cell" + (l == s - 1 ? " gantt_last_cell" : ""), (_ = r.task_cell_class(e, a.trace_x[l])) && (c += " " + _), h.className = c, o.appendChild(h)
                    }
                }
            var u = t.getGlobalTaskIndex(e.id) % 2 != 0,
                _ = r.task_row_class(e.start_date, e.end_date, e),
                f = "gantt_task_row" + (u ? " odd" : "") + (_ ? " " + _ : "");
            ...
            if (t.isSplitTask(i)) {
                ...
                for (var r = document.createElement("div"), a = t.getTaskPosition(i), s = t.getChildren(i.id), o = 0; o < s.length; o++) {
                    var l = t.getTask(s[o]),
                        d = e(l, n);
                    if (d) {
                        var c = Math.floor((t.config.row_height - a.height) / 2);
                        d.style.top = a.top + c + "px", d.className += " gantt_split_child", r.appendChild(d)
                    }
                }
                return r
            }
    ...
    t.exports = function (t) {
        ...
        return i(2)(r, e), n.mixin(r.prototype, {
            ...
            is_changed: function (e, i, n, r) {
                var o = this.get_value(i, n, r),
                    l = a(s(e, n.editor, t), n.editor);
    ...
    t.exports = function (t) {
        ...
        return i(2)(o, e), n.mixin(o.prototype, {
            show: function (e, i, n, o) {
                ...
                var l = "<div style='width:140px'><input type='date' min='" + a(n.min || t.getState().min_date) + "' max='" + a(n.max || t.getState().max_date) + "' name='" + i.name + "'></div>";
                o.innerHTML = l
            },
            set_value: function (t, e, i, n) {
                this.get_input(n).value = a(t)
            },
            is_valid: function (t, e, i, n) {
    ...
    t.exports = function (t) {
        ...
        return i(2)(r, e), n.mixin(r.prototype, {
            ...
            get_value: function (t, i, n) {
                e.prototype.get_value(t, i, n);
    ...
    t.exports = {
        init: function (t, e) {
            ...
            a.attachEvent("onBeforeFocus", function (e) {
                ...
                var s = t.locateCell(r.target),
                    o = !!s && t.getEditorConfig(s.columnName),
                    l = t.getState(),
                    d = n.constants.KEY_CODES,
                    c = r.keyCode,
                    h = !1;
                switch (c) {
                    case d.ENTER:
                    ...
                    case d.TAB:
                        ...
                        break;
                    default:
                        t.isVisible() ? h = !0 : (c >= 48 && c <= 57 || c > 95 && c < 112 || c >= 64 && c <= 91 || c > 185 && c < 193 || c > 218 && c < 223) && o && !t.isVisible() && (i.show(s.id, s.columnName), i.setValue(), h = !0)
                }
                return !h
            })
        },
    ...
    t.exports = function () {
        var t = null;
        return {
            setMapping: function (e) {
                t = e
            },
            getMapping: function () {
                return t || (gantt.config.keyboard_navigation_cells ? r : n)
            }
        }
    }
}, function (t, e, i) {
    ...
    t.exports = function (t, e) {
        var i = {
            column_before_start: t.bind(function (t, i, r) {
                ...
                var s = this.locate(r, a.grid_resizer_column_attribute),
            ...
            column_drag_move: t.bind(function (i, r, a) {
                var s = e.$getConfig(),
                    o = i.config,
                    l = e.getGridColumns(),
                    d = parseInt(o.drag_index, 10),
                    c = l[d],
                    h = n.getNodePosition(e.$grid_scale),
                    u = parseInt(o.marker.style.left, 10),
                    _ = c.min_width ? c.min_width : s.min_grid_column_width,
                    f = e.$grid_data.offsetWidth,
                    g = 0,
                    p = 0;
                s.rtl ? u = h.x + h.width - 1 - u : u -= h.x - 1;
                for (var v = 0; v < d; v++) _ += l[v].width, g += l[v].width;
                if (u < _ && (u = _), s.keep_grid_width) {
                    var m = 0;
                    for (v = d + 1; v < l.length; v++) l[v].min_width ? f -= l[v].min_width : s.min_grid_column_width && (f -= s.min_grid_column_width), l[v].max_width && !1 !== m ? m += l[v].max_width : m = !1;
                    m && (_ = e.$grid_data.offsetWidth - m), u < _ && (u = _), u > f && (u = f)
                } else if (!e.$config.scrollable) {
                    var y = u,
                        k = 0;
                    for (v = d + 1; v < l.length; v++) k += l[v].width;
                    y + k > t.$container.offsetWidth && (u = t.$container.offsetWidth - k)
                }
                return o.left = u - 1, p = Math.abs(u - g), c.max_width && p > c.max_width && (p = c.max_width), s.rtl && (g = h.width - g + 2 - p), o.marker.style.top = h.y + "px", o.marker.style.left = h.x - 1 + g + "px", o.marker.style.width = p + "px", e.callEvent("onColumnResize", [d, l[d], p - 1]), !0
            }, t),
            column_drag_end: t.bind(function (i, n, r) {
                for (var a = e.$getConfig(), s = e.getGridColumns(), o = 0, l = parseInt(i.config.drag_index, 10), d = s[l], c = 0; c < l; c++) o += s[c].width;
                ...
                if (d.max_width && d.max_width < h && (h = d.max_width), !1 !== e.callEvent("onColumnResizeEnd", [l, d, h]) && d.width != h) {
                    if (d.width = h, a.keep_grid_width) o = a.grid_width;
                    else {
                        c = l;
                        for (var u = s.length; c < u; c++) o += s[c].width
                    }
        ...
        a = function (t, e) {
            ...
            function l(t, e, i) {
                ...
                return function (t, e, i, n, a, s) {
                    ...
                    for (var d = 1 * s.rightBorderWidth, c = r(s.rightBorderColor), h = 0, u = 0, _ = 0, f = 1; f <= n; f++)
                        for (h = f * e - 1, _ = 0; _ < d; _++)
                            for (u = 0; u < t * i; u++) l(h - _, u, c, o);
                    var g = 1 * s.bottomBorderWidth,
                        p = r(s.bottomBorderColor);
                    u = 0;
                    for (var v = 1; v <= i; v++)
                        for (u = v * t - 1, _ = 0; _ < g; _++)
                            for (h = 0; h < e * n; h++) l(h, u - _, p, o);
                    ...
                    if (i.static_background && document.createElement("canvas").getContext) {
                        ...
                        var h = function (t, i, n, r) {
                                var a, s, o = [],
                                    ...
                                    h = 1e5;
                                if (e.isIE) {
                                    var u = navigator.appVersion || ""; - 1 == u.indexOf("Windows NT 6.2") && -1 == u.indexOf("Windows NT 6.1") && -1 == u.indexOf("Windows NT 6.0") || (h = 2e4)
                                }
                                for (var _ = 0; _ < d.length; _++) {
                                    var f = d[_];
                                    if (f != s && void 0 !== s || _ == d.length - 1 || l > h) {
                                        for (var g = r, p = 0, v = Math.floor(h / i.row_height) * i.row_height, m = l; g > 0;) {
                                            var y = Math.min(g, v);
                                            g -= v, (a = document.createElement("div")).style.height = y + "px", a.style.position = "absolute", a.style.top = p + "px", a.style.left = c + "px", a.style.whiteSpace = "no-wrap", a.className = t[s || f], _ == d.length - 1 && (m = f + m - 1), a.style.width = m + "px", o.push(a), p += y
                                        }
                                        l = 0, c += m
                                    }
                                    f && (l += f, s = f)
                                ...
                                for (var _ in c) {
                                    ...
                                    if (!p) {
                                        var v = l(f, h, t);
                                        o(g, v), u += "." + d(g) + "{ background-image: url('" + v + "');}"
                                    }
                                    r[_] = d(g)
                                }
                                if (u) {
    ...
    t.exports = function (t) {
        ...
        return {
            ...
            prepareConfigs: function (t, e, i, n, r, a, s) {
                ...
                for (c = 0; c < d.length - 1; c++) this.alineScaleColumns(d[d.length - 1], d[c]);
                for (c = 0; c < d.length; c++) s && this.reverseScale(d[c]), this.setPosSettings(d[c]);
                return d
            },
            ...
            initColSizes: function (t, i, n, r) {
                ...
                for (var o = t.ignore_x || {}, l = 0; l < t.trace_x.length; l++)
                    if (o[t.trace_x[l].valueOf()] || t.display_count == t.count) t.width[l] = 0;
                    else {
                        var d = 1;
                        "month" == t.unit && (d = Math.round((e.add(t.trace_x[l], t.step, t.unit) - t.trace_x[l]) / 864e5)), t.width[l] = d
            ...
            return n(e, t), e.prototype.init = function (t) {
                ...
                for (var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", s = n ? "contentX" : "contentY", o = n ? "x" : "y", l = this._getScrollOffset(), d = 0; d < r.length; d++)
                    if ((t = r[d]) && t.$content && t.$content.getSize && !t.$config.hidden) {
                        ...
                        if (c = h.hasOwnProperty(a) ? h[a] : h[s], l) h[s] > h[o] && h[s] > e && c > h[o] - l + 2 && (e = c + (n ? 0 : 2), i = h[o]);
                        else {
                            var u = Math.max(h[s] - c, 0);
                            (c += u) > Math.max(h[o] - u, 0) && c > e && (e = c, i = h[o])
                        }
                    } return {
                    outerScroll: i,
                    innerScroll: e
                ...
                if (this._checkWheelTarget(e)) {
                    ...
                    if (!t.shiftKey || t.deltaX || t.wheelDeltaX || (r = 2 * a, a = 0), r && Math.abs(r) > Math.abs(a)) {
                        ...
                        var o = r / -40,
                            l = this._oldLeft,
                            d = l + 30 * o;
                        if (this.scrollHorizontally(d), this.$scroll_hor.scrollLeft = d, l == this.$scroll_hor.scrollLeft) return !0;
                        ...
                        if (this.scrollVertically(h), this.$scroll_ver.scrollTop = h, c == this.$scroll_ver.scrollTop) return !0;
            ...
            createGroup: function (i, n, o) {
                var l = {
                    ...
                    _add: function (t) {
                        ...
                        for (var i = this.container(), s = this.tempCollection, o = 0; o < s.length; o++)
                            if (t = s[o], this.container() || t && t.container && a.isChildOf(t.container, document.body)) {
                                var l = t.container,
                                    d = t.id,
                                    c = t.topmost;
                                if (!l.parentNode)
                                    if (c) i.appendChild(l);
                                    else {
                    ...
                    addLayer: function (t) {
                        return t && ("function" == typeof t && (t = {
                            renderer: t
                        }), void 0 === t.filter ? t.filter = s(o || []) : t.filter instanceof Array && (t.filter.push(o), t.filter = s(t.filter)), t.container || (t.container = document.createElement("div"))), this._add(t), t ? t.id : void 0
                    },
    ...
    var n = function (t) {
        return function (e) {
            ...
            function r(t) {
                (t = t || window.event).target || t.srcElement;
                var n = e.locate(t),
                    r = s(t, i.click),
                    a = !0;
                ...
                for (var n = e.target || e.srcElement, r = []; n;) {
                    ...
                    if (a) {
                        ...
                        for (var s = 0; s < a.length; s++)
                            if (a[s] && i[a[s]])
                                for (var o = i[a[s]], l = 0; l < o.length; l++) o[l].root && !t.isChildOf(n, o[l].root) || r.push(o[l].handler)
                    }
                    n = n.parentNode
                }
                return r
            ...
            function h(t) {
                c.detachAll(), t && (c.attach(t, "click", r), c.attach(t, "dblclick", l), c.attach(t, "mousemove", d), c.attach(t, "contextmenu", a))
            }
            return {
                reset: h,
                ...
                callHandler: function (t, e, n, r) {
                    var a = i[t][e];
                    if (a)
                        for (var s = 0; s < a.length; s++)(n || a[s].root) && a[s].root !== n || a[s].handler.apply(this, r)
                },
                onDoubleClick: l,
                onMouseMove: d,
                onContextMenu: a,
    ...
    t.exports = {
        createFactory: function (t) {
            ...
            function a(a, s, o, l) {
                ...
                var c = new d.create(s, o, this, t);
                return d.configure && d.configure(c), r(c, l), c.$id || (c.$id = o.id || t.uid()), c.$parent || "object" != typeof s || (c.$parent = s), c.$config || (c.$config = o), i[c.$id] && (c.$id = t.uid()), i[c.$id] = c, c
            }
            return {
                initUI: function (t, e) {
                    var i = "cell";
    ...
    t.exports = {
        init: function (t) {
            ...
            i.registerView("cell", s), i.registerView("resizer", c), i.registerView("scrollbar", h), i.registerView("layout", o, function (t) {
                "main" === (t.$config ? t.$config.id : null) && e(t, w)
            }), i.registerView("viewcell", d), i.registerView("multiview", l), i.registerView("timeline", u, function (t) {
                "timeline" !== (t.$config ? t.$config.id : null) && "task" != t.$config.bind || e(t, x)
            }), i.registerView("grid", _, function (t) {
                "grid" !== (t.$config ? t.$config.id : null) && "task" != t.$config.bind || e(t, $)
            }), i.registerView("resourceGrid", f), i.registerView("resourceTimeline", g);
            var S = a(t),
                T = p(t);
            return t.ext.inlineEditors = T, t.ext._inlineEditors = T, T.init(t), {
                ...
                layersService: {
                    getDataRender: function (e) {
                        return S.getDataRender(e, t)
                    },
                    createDataRender: function (e) {
                        return S.createDataRender(e, t)
                    }
                }
            }
        }
    ...
    t.exports = function (t) {
        ...
        function a(t, e) {
            var i = t.callback;
            g.hide(t.box), r = t.box = null, i && i(e)
        }
            ...
            if (r) {
                ...
                if (v.keyboard) {
                    if (13 == e || 32 == e) {
                        ...
                        p.getClassName(n).indexOf("gantt_popup_button") > -1 && n.click ? n.click() : (a(r, !0), i = !0)
                    }
                    27 == e && (a(r, !1), i = !0)
                }
        ...
        function o(t) {
            o.cover || (o.cover = document.createElement("div"), o.cover.onkeydown = s, o.cover.className = "dhx_modal_cover", document.body.appendChild(o.cover));
            document.body.scrollHeight;
            o.cover.style.display = t ? "inline-block" : "none"
        }
        ...
        function c(i, c, h) {
            var u = i.tagName ? i : function (i, s, o) {
                var c = document.createElement("div"),
                    h = (t.locale, n.uid());
                t._waiAria.messageModalAttr(c, h), c.className = " gantt_modal_box dhtmlx_modal_box gantt-" + i.type + " dhtmlx-" + i.type, c.setAttribute(e, 1);
                var u = "";
                if (i.width && (c.style.width = i.width), i.height && (c.style.height = i.height), i.title && (u += '<div class="gantt_popup_title dhtmlx_popup_title">' + i.title + "</div>"), u += '<div class="gantt_popup_text dhtmlx_popup_text" id="' + h + '"><span>' + (i.content ? "" : i.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">', s && (u += l(d(i.ok, t.locale.labels.message_ok, "OK"), "ok", !0)), o && (u += l(d(i.cancel, t.locale.labels.message_cancel, "Cancel"), "cancel", !1)), i.buttons)
                    for (var _ = 0; _ < i.buttons.length; _++) {
                        var f = i.buttons[_];
                        u += "object" == typeof f ? l(f.label, f.css || "gantt_" + f.label.toLowerCase() + "_button dhtmlx_" + f.label.toLowerCase() + "_button", f.value || _) : l(f, f, _)
                    }
                if (u += "</div>", c.innerHTML = u, i.content) {
                    var g = i.content;
                    "string" == typeof g && (g = document.getElementById(g)), "none" == g.style.display && (g.style.display = ""), c.childNodes[i.title ? 1 : 0].appendChild(g)
                }
                return c.onclick = function (t) {
                    ...
                    if (e.className || (e = e.parentNode), "gantt_popup_button" == e.className.split(" ")[0]) {
                        ...
                        a(i, n = "true" == n || "false" != n && n)
                    }
                }, i.box = c, (s || o) && (r = i), c
            }(i, c, h);
            i.hidden || o(!0), document.body.appendChild(u);
            var _ = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - u.offsetWidth) / 2)),
                f = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - u.offsetHeight) / 2));
            return "top" == i.position ? u.style.top = "-3px" : u.style.top = f + "px", u.style.left = _ + "px", u.onkeydown = s, g.focus(u), i.hidden && g.hide(u), t.callEvent("onMessagePopup", [u]), u
        }
        ...
        g.focus = function (t) {
            setTimeout(function () {
                var e = p.getFocusableNodes(t);
                e.length && e[0].focus && e[0].focus()
            }, 1)
        };
        var v = function (e, i, r, a) {
            switch ((e = function (t, e, i, r) {
                return "object" != typeof t && (t = {
                    ...
                    expire: i,
                    id: r
                }), t.id = t.id || n.uid(), t.expire = t.expire || v.expire, t
                ...
                default:
                    return function (e) {
                        v.area || (v.area = document.createElement("div"), v.area.className = "gantt_message_area dhtmlx_message_area", v.area.style[v.position] = "5px", document.body.appendChild(v.area)), v.hide(e.id);
                        var i = document.createElement("div");
                        return i.innerHTML = "<div>" + e.text + "</div>", i.className = "gantt-info dhtmlx-info gantt-" + e.type + " dhtmlx-" + e.type, i.onclick = function () {
                            v.hide(e.id), e = null
                        }, t._waiAria.messageInfoAttr(i), "bottom" == v.position && v.area.firstChild ? v.area.insertBefore(i, v.area.firstChild) : v.area.appendChild(i), e.expire > 0 && (v.timers[e.id] = window.setTimeout(function () {
                            v.hide(e.id)
                        }, e.expire)), v.pull[e.id] = i, i = null, e.id
                    }(e)
            }
        };
        v.seed = (new Date).valueOf(), v.uid = n.uid, v.expire = 4e3, v.keyboard = !0, v.position = "top", v.pull = {}, v.timers = {}, v.hideAll = function () {
            for (var t in v.pull) v.hide(t)
        }, v.hide = function (t) {
            var e = v.pull[t];
            e && e.parentNode && (window.setTimeout(function () {
                e.parentNode.removeChild(e), e = null
            }, 2e3), e.className += " hidden", v.timers[t] && window.clearTimeout(v.timers[t]), delete v.pull[t])
        };
        var m = [];
        return t.attachEvent("onMessagePopup", function (t) {
            m.push(t)
        }), t.attachEvent("onAfterMessagePopup", function (t) {
            for (var e = 0; e < m.length; e++) m[e] === t && (m.splice(e, 1), e--)
        }), t.attachEvent("onDestroy", function () {
            o.cover && o.cover.parentNode && o.cover.parentNode.removeChild(o.cover);
            for (var t = 0; t < m.length; t++) m[t].parentNode && m[t].parentNode.removeChild(m[t]);
            m = null, v.area && v.area.parentNode && v.area.parentNode.removeChild(v.area), v = null
        }), {
            alert: function () {
                var t = f.apply(this, arguments);
    ...
    i(15), t.exports = function () {
        var t = new function () {
            this.constants = i(133), this.version = "5.2.0", this.templates = {}, this.ext = {}, this.keys = {
                edit_save: this.constants.KEY_CODES.ENTER,
                edit_cancel: this.constants.KEY_CODES.ESC
            }
        };
        i(132)(t), t.$services = t.$inject(i(131)), t.config = t.$inject(i(130)), t.ajax = i(129)(t), t.date = i(128)(t);
        var e = i(127)(t);
        ...
        var a = i(0);
        a.mixin(t, a), t.env = i(9);
        var s = i(29)();
        t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(124)(t));
        var o = i(123).init(t);
        ...
        }), t.mixin(t, o.layersApi), i(89)(t), t.$services.setService("layers", function () {
            return o.layersService
        });
        var l = i(88);
        return t.mixin(t, l()), i(87)(t), i(81)(t), i(78)(t), i(69)(t), i(68)(t), i(66)(t), i(65)(t), i(64)(t), i(63)(t), i(56)(t), i(55)(t), i(47)(t), i(46)(t), i(44)(t), i(43)(t), i(42)(t), i(41)(t), i(40)(t), i(39)(t), i(38)(t), i(37)(t), i(36)(t), i(35)(t), i(16)(t), i(34)(t), i(32)(t), t
    }
}, function (t, e, i) {
    var n = {
        _seed: 0,
        ...
        getGanttInstance: function () {
            for (var t = i(134)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
            return t._internal_id = n._seed++, n.$syncFactory && n.$syncFactory(t), i(31)(t), t
        }
    };
    t.exports = n
}, function (t, e, i) {
    ...
    var n = i(135);
    n.plugin(function (t) {
        var e = ["href", "location", "dhtmlx.com/", "indexOf", "error", "This version of Gantt is not intended for using outside of dhtmlx.com", "message", "random", "floor"]; - 1 == document[e[1]][e[0]][e[3]](e[2]) && setTimeout(function () {
            t[e[6]]({
                type: e[4],
                text: e[5],
                expire: -1
    ...
    var r = window;
    r.Gantt = n, r.gantt = n.getGanttInstance()
}]);